      ...
      <div className="w-full max-w-screen-md space-y-6">
        ...
        <ol className="list-decimal list-inside space-y-4">
          <li className="text-gray-700">
            ...
            accessing and using the AI chatbot ("Chatbot") provided by Benjamin Hadad
          ...
          <li className="text-gray-700">
            ...
            or implied. Benjamin Hadad makes no representations or warranties regarding
          ...
          <li className="text-gray-700">
            ...
            Benjamin Hadad does not guarantee that the Chatbot will be available at all
          ...
          <li className="text-gray-700">
            ...
            the fullest extent permitted by applicable law, Benjamin Hadad shall not be
            ...
            Benjamin Hadad has been advised of the possibility of such damages.
          </li>
          <li className="text-gray-700">
            <span className="font-semibold">
          ...
          <li className="text-gray-700">
            ...
            decisions made based on its output. Benjamin Hadad is not responsible for any
          ...
          <li className="text-gray-700">
            ...
            considered equivalent to public postings, and Benjamin Hadad does not
          ...
          <li className="text-gray-700">
            ...
            indemnify, defend, and hold harmless Benjamin Hadad from any claims,
            liabilities, damages, losses, and expenses, including reasonable
            legal fees, arising from your use of the Chatbot or violation of
            these Terms of Use.
          </li>
          <li className="text-gray-700">
            <span className="font-semibold">Modifications to Terms:</span> Benjamin Hadad
          ...
          <li className="text-gray-700">
            ...
            contact Benjamin Hadad at webmaster@bsh.dev.
          </li>
        </ol>
      </div>
    </div>
